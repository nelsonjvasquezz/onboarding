...
(
    ...
    [pro_unidad_duracion] VARCHAR(50) CONSTRAINT [DF_obd_pro_unidad_duracion] DEFAULT ('Días') NOT NULL,
    ...
    CONSTRAINT [CK_pro_programas_estado] CHECK (pro_estado in ('Planificado', 'En Ejecución', 'Finalizado')),
    CONSTRAINT [CK_pro_programas_unidad_duracion] CHECK (pro_unidad_duracion in ('Minutos', 'Horas', 'Días', 'Semanas', 'Meses', 'Años'))
)
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Estado del programa ''Planificado'' o ''En Ejecución'' o ''Finalizado''',
    @level0type = N'SCHEMA',
    @level0name = N'obd',
    @level1type = N'TABLE',
    @level1name = N'pro_programas',
