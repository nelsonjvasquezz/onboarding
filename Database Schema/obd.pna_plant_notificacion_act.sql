...
(
    ...
    [pna_offset_inicio] INT CONSTRAINT [DF_obd_pna_offset_inicio] DEFAULT ((0)) NOT NULL,
    [pna_offset_fin] INT CONSTRAINT [DF_obd_pna_offset_fin] DEFAULT ((0)) NOT NULL,
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Código de registro de notificaciones de la actividad de la plantilla',
    @level0type = N'SCHEMA',
    @level0name = N'obd',
    @level1type = N'TABLE',
