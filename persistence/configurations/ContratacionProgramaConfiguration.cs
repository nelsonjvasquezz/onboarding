...
namespace onboarding.persistence.configurations
{
    public class ContratacionProgramaConfiguration : IEntityTypeConfiguration<ContratacionPrograma>
    {
        ...
        public void Configure(EntityTypeBuilder<ContratacionPrograma> builder)
        {
            ...
            builder.Property(e => e.FechaContratacion).HasColumnName("cpr_fecha_contratacion").HasColumnType("datetime");
            builder.Property(e => e.FechaFin).HasColumnName("cpr_fecha_fin").HasColumnType("datetime");
            builder.Property(e => e.FechaGrabacion).HasColumnName("cpr_fecha_grabacion").HasColumnType("datetime");
            builder.Property(e => e.FechaInicio).HasColumnName("cpr_fecha_inicio").HasColumnType("datetime");
            builder.Property(e => e.FechaModificacion).HasColumnName("cpr_fecha_modificacion").HasColumnType("datetime");
            ...
            builder.HasOne(d => d.Programa).WithMany(p => p.ContratacionesProgramas)
