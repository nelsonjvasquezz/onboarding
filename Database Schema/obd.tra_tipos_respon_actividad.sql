...
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Tabla de Tipos de resposnables de las Actividades',
    @level0type = N'SCHEMA',
    @level0name = N'obd',
    @level1type = N'TABLE',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Código de Tipo de Resonsable de Actividad',
    @level0type = N'SCHEMA',
    @level0name = N'obd',
    @level1type = N'TABLE',
    @level1name = N'tra_tipos_respon_actividad',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Nombre del Tipo de Resonsable de Actividad',
    @level0type = N'SCHEMA',
    @level0name = N'obd',
    @level1type = N'TABLE',
    @level1name = N'tra_tipos_respon_actividad',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Descripción del Tipo de Resonsable de Actividad',
    @level0type = N'SCHEMA',
    @level0name = N'obd',
    @level1type = N'TABLE',
    @level1name = N'tra_tipos_respon_actividad',
